...
{
    //The diameter of the area where the agent and flower can be used for observing relative distance from agent to flower
    ...
    /// </summary>
    /// <param name="collider"></param> the nectar collider
    /// <returns></returns>
    ...
    /// <summary>
    /// Recursively finds all flowers and flower plants that are children of a aprent transform
    /// </summary>
